...
![](/img/pwnti/b00ks/image-20221025152027671.png)

checksec之后可知是amd64的结构，放入IDA64中分析，进入找到main函数按F5键查看伪代码。

### main

![](/img/pwnti/b00ks/image-20221025152231748.png)

### sub_A77

首先初始化stdout和stdin，sub_A77函数输出一行文字

![](/img/pwnti/b00ks/image-20221025152349337.png)

### sub_B6D

sub_B6D函数需要输入作者名称，将读入名字author_name，其中`32LL`为0x20的长度，还需要进一步看sub_9F5函数。

![](/img/pwnti/b00ks/image-20221025152439174.png)

sub_B6D函数最后效果为将name读入到0x02040位置。

![](/img/pwnti/b00ks/image-20221025154415885.png)
...
![](/img/pwnti/b00ks/image-20221025152645662.png)
...
![](/img/pwnti/b00ks/image-20221025154600040.png)
...
![](/img/pwnti/b00ks/image-20221025155340205.png)

### sub_B24

sub_B24函数主要在off_202010到之后的共20的位置查看是否有值，若为0，则说明有空闲位置，返回空闲的位置所代表的i。

![](/img/pwnti/b00ks/image-20221025160305683.png)
...
![](/img/pwnti/b00ks/image-20221025155403683.png)

![](/img/pwnti/b00ks/image-20221025155423752.png)

### sub_BBD

输入要删除的id，然后进行free并且赋值为0。

![](/img/pwnti/b00ks/image-20221025161124844.png)

### sub_E17

![](/img/pwnti/b00ks/image-20221025161226153.png)
...
![](/img/pwnti/b00ks/image-20221025161344963.png)
...
![](/img/pwnti/b00ks/image-20221025161745008.png)
...
![](/img/pwnti/b00ks/image-20221025164051973.png)
...
![](/img/pwnti/b00ks/image-20221025164827903.png)

![](/img/pwnti/b00ks/image-20221025164901716.png)

输入find aaaaaaaaaaaaaaaaaaaaaaaaaaaaaabc找到相应的位置

![](/img/pwnti/b00ks/image-20221025164948519.png)

![](/img/pwnti/b00ks/image-20221025165159813.png)
...
![](/img/pwnti/b00ks/image-20221025165920156.png)

创建两个book：

![](/img/pwnti/b00ks/image-20221025170206730.png)

![](/img/pwnti/b00ks/image-20221025170553060.png)
...
![](/img/pwnti/b00ks/image-20221025193027006.png)
...
![](/img/pwnti/b00ks/image-20221025194124258.png)
...
![](/img/pwnti/b00ks/image-20221025194929356.png)
...
![](/img/pwnti/b00ks/image-20221025200239349.png)
...
![](/img/pwnti/b00ks/image-20221025202226764.png)

![](/img/pwnti/b00ks/image-20221025202507871.png)
...
![](/img/pwnti/b00ks/image-20221025203052919.png)

![](/img/pwnti/b00ks/image-20221025203210290.png)

泄露得到libc基址：

![](/img/pwnti/b00ks/image-20221025203346725.png)
...
![](/img/pwnti/b00ks/image-20221025203755878.png)

此时book2的description为free_hook指针地址

![](/img/pwnti/b00ks/image-20221025204108883.png)

然后修改book2的description，使得free_hook指针地址指向system，

![](/img/pwnti/b00ks/image-20221025204344639.png)
...
![](/img/pwnti/b00ks/image-20221025204924268.png)
